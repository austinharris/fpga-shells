...
package sifive.fpgashells.ip.xilinx.vu190xdma
...
class VU190XDMAIODDR(depth: BigInt) extends GenericParameterizedBundle(depth) {
  //outputs
...
trait VU190XDMAIOClocksReset extends Bundle {
  //clock, reset
...
class vu190xdma(depth: BigInt)(implicit val p:Parameters) extends BlackBox 
{
  val io = new VU190XDMAIODDR(depth) with VU190XDMAIOClocksReset {
  ...
  val vu190xdma_bd = """
      ...
      CONFIG.STRATEGY {2} \
        ...
        set parts_file [file join [pwd]/../../fpga-shells/xilinx/vu190/MTA36ASF4G72PZ-2G1.csv]
      ...
      CONFIG.xdma_wnum_chnl {2} \
        ...
        exclude_bd_addr_seg [get_bd_addr_segs c0_ddr4_s_axi_ctrl/SEG_ddr4_0_C0_REG]
  ...
  val bdtcl = vu190xdma_bd

  ElaborationArtefacts.add(
    "vu190xdma.vivado.tcl",
       bdtcl++"""
       ipx::package_project -root_dir $ipdir -vendor xilinx.com -library ip -taxonomy /UserIP -module vu190_xdma -import_files
       set_property core_revision 2 [ipx::find_open_core xilinx.com:ip:vu190_xdma:1.0]
       ipx::create_xgui_files [ipx::find_open_core xilinx.com:ip:vu190_xdma:1.0]
       ipx::update_checksums [ipx::find_open_core xilinx.com:ip:vu190_xdma:1.0]
       ipx::save_core [ipx::find_open_core xilinx.com:ip:vu190_xdma:1.0]
       update_ip_catalog -rebuild
       create_ip -vendor xilinx.com -name vu190_xdma -library ip -version 1.0 -module_name vu190xdma
